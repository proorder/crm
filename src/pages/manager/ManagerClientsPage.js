...
import { errorProcessing, changeClientState } from '../../utils';
...
class ManagerClientsPage extends React.Component {
  static path = '/clients';
...
export default connect(state => ({ store: state }))(ManagerClientsPage);
